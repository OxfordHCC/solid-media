import { c as commonjsGlobal } from './_commonjsHelpers-fdecda49.js';
...
const { rdf, xsd: xsd$1 } = namespaces;
...
class Literal extends Term {
  ...
  get datatypeString() {
    ...
    return char === '^' ? id.substr(dtPos + 2) :
           ...
           (char !== '@' ? xsd$1.string : rdf.langString);
  }
...
const DEFAULTGRAPH$1 = DataFactory.defaultGraph();

const { rdf: rdf$1, xsd: xsd$2 } = namespaces;
...
class N3Writer {
  ...
  _encodeLiteral(literal) {
    ...
    if (this._lineMode) {
      ...
      if (literal.datatype.value === xsd$2.string)
        return `"${value}"`;
    }
    else {
...
export { Buffer as B, N3Writer as N, N3Parser as a, global as g };
